...
onMounted(async () => {
  ...
  myChart.setOption({
    ...
    //     type: 'polygon',
    //     shape: {
    //       points: calculatePoints([[100, 70], [750, 70], [700, 200], [50, 200]])  //左上、右上、右下、左下
    //     },
    //     style: {
    //       fill: '#eee',
    //       stroke: 'red',
    ...
    //     type: 'polygon',
    //     shape: {
    //       points: calculatePoints([[50, 440], [700, 440], [750, 310], [100, 310]])  //左下、右下、右上、左上
    //     },
    //     style: {
    //       fill: '#eee',
    //       stroke: 'blue',
      ...
      <el-tab-pane label="任务划分">
        ...
        <el-row style="margin-bottom:20px;">
          <el-col :span="12" style="margin-left:40px">
            <div id="main" style="width: 1000px;height:400px;margin-left:100px;background-color: rgba(250,247,247,0.5)"></div>
          </el-col>
