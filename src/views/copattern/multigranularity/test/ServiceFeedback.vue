    ...
    <el-form-item label="客服响应">
      <div class="rating-container">
        <div
          ...
          :class="['rating-box', { active: index < hoveredCustomerServiceResponseIndex, filled: index < feedbackForm.customerServiceResponse }]"
      ...
      <span class="rating-text">
        <span v-if="selectedCustomerServiceResponseText !== null">{{ selectedCustomerServiceResponseText }}</span>
        <span v-else-if="hoveredCustomerServiceResponseIndex === 0">不满意</span>
        <span v-else-if="hoveredCustomerServiceResponseIndex === 1">基本满意</span>
        <span v-else-if="hoveredCustomerServiceResponseIndex === 2">非常满意</span>
      </span>
    </el-form-item>
    ...
    <el-form-item label="售后服务">
      <div class="rating-container">
        <div
          ...
          :class="['rating-box', { active: index < hoveredAfterSalesServiceIndex, filled: index < feedbackForm.afterSalesService }]"
      ...
      <span class="rating-text">
        <span v-if="selectedAfterSalesServiceText !== null">{{ selectedAfterSalesServiceText }}</span>
        <span v-else-if="hoveredAfterSalesServiceIndex === 0">不满意</span>
        <span v-else-if="hoveredAfterSalesServiceIndex === 1">基本满意</span>
        <span v-else-if="hoveredAfterSalesServiceIndex === 2">非常满意</span>
      </span>
    </el-form-item>
    ...
    <el-form-item label="沟通质量">
      <div class="rating-container">
        <div
          ...
          :class="['rating-box', { active: index < hoveredCommunicationQualityIndex, filled: index < feedbackForm.communicationQuality }]"
      ...
      <span class="rating-text">
        <span v-if="selectedCommunicationQualityText !== null">{{ selectedCommunicationQualityText }}</span>
        <span v-else-if="hoveredCommunicationQualityIndex === 0">不满意</span>
        <span v-else-if="hoveredCommunicationQualityIndex === 1">基本满意</span>
        <span v-else-if="hoveredCommunicationQualityIndex === 2">非常满意</span>
      </span>
    </el-form-item>
    ...
    <el-form-item label="异常处理">
      <div class="rating-container">
        <div
          ...
          :class="['rating-box', { active: index < hoveredExceptionHandlingIndex, filled: index < feedbackForm.exceptionHandling }]"
      ...
      <span class="rating-text">
        <span v-if="selectedExceptionHandlingText !== null">{{ selectedExceptionHandlingText }}</span>
        <span v-else-if="hoveredExceptionHandlingIndex === 0">不满意</span>
        <span v-else-if="hoveredExceptionHandlingIndex === 1">基本满意</span>
        <span v-else-if="hoveredExceptionHandlingIndex === 2">非常满意</span>
      </span>
    </el-form-item></div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    setCustomerServiceResponseRating(rating) {
      ...
      this.selectedCustomerServiceResponseText = this.getRatingText(rating);
    },
