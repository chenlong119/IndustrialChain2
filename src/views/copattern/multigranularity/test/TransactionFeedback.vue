...
export default {
  ...
  data() {
    return {
      hoveredPaymentProcessIndex: -1,
      selectedPaymentProcessText: null,
  ...
  methods: {
    hoverOverPaymentProcess(index) {
      this.hoveredPaymentProcessIndex = index;
    },
    hoverOutPaymentProcess() {
      this.hoveredPaymentProcessIndex = -1;
    },
    setPaymentProcessRating(rating) {
      this.feedbackForm.paymentProcess = rating;
      this.selectedPaymentProcessText = this.getRatingText(rating);
    },
    ...
    setPriceRating(rating) {
      ...
      this.selectedPriceRatingText = this.getRatingText(rating);
    },
