...
<el-form-item label="产品外观">
  <div class="rating-container">
    <div
      ...
      :class="['rating-box', { active: index < hoveredAppearanceIndex, filled: index < feedbackForm.productAppearance }]"
  ...
  <span class="rating-text">
    <span v-if="selectedAppearanceText !== null">{{ selectedAppearanceText }}</span>
    <span v-else-if="hoveredAppearanceIndex === 0">不满意</span>
    <span v-else-if="hoveredAppearanceIndex === 1">基本满意</span>
    <span v-else-if="hoveredAppearanceIndex === 2">非常满意</span>
  </span>
</el-form-item>
...
setPackagingRating(rating) {
  ...
  this.selectedPackagingText = ["不满意", "基本满意", "非常满意"][rating - 1];
},

  setAppearanceRating(rating) {
    this.feedbackForm.productAppearance = rating;
    this.selectedAppearanceText = ["不满意", "基本满意", "非常满意"][rating - 1];
  },
...
hoverOverDataAccuracy(index) {
  ...
  setDataAccuracyRating(rating) {
    ...
    this.selectedDataAccuracyText  = ["不满意", "基本满意", "非常满意"][rating - 1];
