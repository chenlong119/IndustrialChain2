<template>
  ...
  <div class="common-layout">
    ...
    <div id="relationChart" ref="relationChart"
         style="width: 750px;height:400px;background-color: rgba(250,247,247,0.5)"></div>
    ...
    <el-main>
      ...
      <div class="container-t">
        <el-table :data="relatedNodesWithout.value" style="height:260px" highlight-current-row
          ...
          <el-table-column prop="id" label="企业id" align="center"/>
          ...
          <el-table-column prop="relation" label="关联强度（0~1）" align="center"/>
          <el-table-column prop="analysis" label="关联分析" align="center">
...
//绘制ECharts关系图
    ...
    graphic: [
...

      {
        ...
        children: [
          ...
          {
            type: 'text',
            position: [5, 5], // 相对于 group 左上角位置的偏移量
            style: {
              text: '竞争关系', // 你要显示的文字
              fill: 'red', // 文字颜色
              fontSize: 14 // 文字大小
  ...
  myChart2.setOption({
        ...
        children: [
          {
            type: 'polygon',
            shape: {
              points: calculatePoints([[-30, -70], [670, -70], [635, 110], [-70, 110]])  // 左上、右上、右下、左下
            },
            style: {
              fill: '#eee',
              stroke: 'black',
          ...
          {
            type: 'text',
            position: [-65, 70], // 相对于 group 左上角位置的偏移量
            style: {
              text: '整体关联关系', // 你要显示的文字
              fill: 'black', // 文字颜色
              fontSize: 14 // 文字大小
    ...
    legend: [
      {
        data: graph2.categories.map(function (a) {
          return a.name;
        })
      }
    ],
