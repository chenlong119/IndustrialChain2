<template>
  <body>
    ...
    <div>
      <el-main tyle="width: 100%;">
          <el-table :data="tableData" border stripe :header-cell-class-name="headerBg" @selection-change="handleSelectionChange" :fit="true">
            ...
            <el-table-column prop="profit" label="共享积分" >
            </el-table-column>
    ...
    <div>
      ...
      <el-dialog v-model="isPopupVisible" title="今日推荐" @close="hidePopup" 
      :width="dialogWidth" 
      :height="dialogHeight" >
        <el-table :data="tableData1" border stripe :header-cell-class-name="headerBg" :fit="true">
            <el-table-column type="selection" > <!--多选框-->
            </el-table-column>
            <el-table-column prop="taskName" label="数据需求" >
            </el-table-column>
            ...
            <el-table-column prop="probability" label="按期完成概率(%)" >
            </el-table-column>
...
export default {
  ...
  mounted() {
    ...
    // setTimeout(() => {
    //       this.createEchartsAccess1();
    //     }, 3)
    setTimeout(() => {
          this.createEchartscategory1();
        }, 3)
    // setTimeout(() => {
    //       this.createEchartsscater1();
    //     }, 3)
  },
  beforeDestroy() {
  },
